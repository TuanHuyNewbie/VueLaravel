        ...
        <v-row>
            <v-col cols="10" style="padding: 0; margin: 0;">
                ...
                <div style="height: 60px; background-color: antiquewhite; display: flex;">
                    <v-row align="center" justify="space-around">
                        <b style="font-size: 30px;">Tạo Người Dùng Mới</b>
                    </v-row>
                </div>
                                    ...
                                    <v-row style="margin: 0; padding: 0; width: 100%;" justify="space-around">
                                            ...
                                            <v-row class="pt-8">
                                                ...
                                                <v-col align-self="center">
                                                    <v-file-input :rules="rules" label="File input" filled
                                                        prepend-icon="mdi-camera" v-model="nguoiDung.hinh_anh"></v-file-input>
                                                </v-col>
                                            </v-row>
                                        </v-col>
                                        ...
                                        <v-col>
                                            <v-row>
                                                ...
                                                <v-col align-self="center">
                                                    <v-text-field type="text" v-model="nguoiDung.ho_va_ten" label="Họ Và Tên"
                                                        :rules="rules">
                                                    </v-text-field>
                                                </v-col>
                                            </v-row>
                                            <v-row>
                                                ...
                                                <v-col align-self="center">
                                                    <v-text-field type="date" :rules="rules" v-model="nguoiDung.ngay_sinh">
                                                    </v-text-field>
                                                </v-col>
                                            </v-row>
                                            <v-row>
                                            ...
                                            <v-row>
                                                ...
                                                <v-col align-self="center">
                                                    <v-select v-model="nguoiDung.trang_thai" item-text="trang_thai2"
