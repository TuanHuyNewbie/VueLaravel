    ...
    <div>
        ...
        <div style="margin: 0; padding: 20px; width: 100%; height: calc(100vh - 230px); overflow: scroll">
            <v-card elavation="7" style="width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;">
                <v-form @submit.prevent="addPhanLoai()" v-model="valid">
                    <div style="display: flex;">
                        ...
                        <v-select item-text="ky_hieu" item-value="id_muc_dich_su_dung_dat" :items="mdsdd" label="Kí Hiệu Mục Đích Sử Dụng Đất (*)" :rules="rules" hide-details="auto" outlined v-model="id_muc_dich_su_dung_dat"></v-select>
                        <v-text-field label="Kí Hiệu Phân Loại(*)" :rules="rules" hide-details="auto" outlined v-model="ky_hieu_phan_loai"></v-text-field>
